function [mlines, cntrs, smsks, pmsks, tcrds, dsts, fnames] = batchStraightener(DIN, dirName, savData, savFigs, vis, par)
%% batchStraightener: function to run carrotExtractor on sub-directories
...
%         batchStraightener(DIN, dirName, savData, savFigs, vis, par)
%
% Input:
...
%       [mlines, cntrs, smsks, pmsks, tcrds, dsts, fnames] = ...
%           batchStraightener(din, nm, 1, 0, 1, 1);
%

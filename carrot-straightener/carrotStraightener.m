function [mline, crv, smsk, pmsk, tcrd, dsts, fname] = carrotStraightener(dataIn, vis, savData, savFigs, par)
...
%         carrotStraightener(dataIn, vis, savData, savFigs, par)
%
% Input:
...
%           carrotStraightener(din, 1, 1, 0, 1);
%

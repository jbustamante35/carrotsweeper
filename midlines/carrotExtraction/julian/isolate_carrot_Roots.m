...
try
    ...
    if DEBUG
        ...
        rng               = 1 : 20 : 201;
        halfIdx           = size(curve(i).data', 2) / 2;
        halfCrd           = curve(i).data(:, halfIdx);
        %halfCrd          = [327 ; 234];
        [tipIdx, tipCrds] = runDebugMode(curve, rng, halfCrd, numCurves);
...
function [tipIdx, tipCrds] = runDebugMode(curve, rng, halfCrd, n)
%%
for k = rng
    col   = 'mo';
    err   = 1;

function [out] = straightKinematics_main_newI(jP)
    out = [];
    try
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            for diskRad = 1:numel(para.diskRadius)
                ...
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                % new interpolation
                [domain,vP] = measureVelocityProfile(para.pointList,1,1,5);
                
                jP.outPort.push('strainNONdomain.mat','domain');
                jP.outPort.push('strainNONvelocity.mat','vP');
                pL = para.pointList;
                jP.outPort.push('pointList.mat','pL');
                close all;

function [swell_fileOut,area_fileOut,para_fileOut,err_fileOut,fit_fileOut,mat_fileOut] = generateOutFileBase(inFile1,oPath,numDeep)
    ...
    mat_fileOut = [oPath 'mat--' fileName '--' '#ROWNUM#' '.mat'];
end
function [J cS] = main_sampleAlongContours_ver2(inFilePath,sPath)
    try
...
%{
    ...
    mkdir(sPath)
    sampleAlongContours_ver2('/mnt/spaldingdata/Takeshi/allMaizeMovies/',sPath);
    sampleAlongContours_ver2('/mnt/spaldingdata/Takeshi/allMaizeMovies/agt mutant/',sPath);
    sampleAlongContours_ver2(fileK,sPath);
    %sampleAlongContours_ver2('/mnt/doane/doane/RIL_Data/999-sm-6-11-7-1000-lg-136-10-19/');
%}
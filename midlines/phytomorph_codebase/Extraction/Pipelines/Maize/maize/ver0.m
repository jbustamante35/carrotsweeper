...
numel(dataFiles);
%% gather expected number of kernels
...
SPOOL = 1;
LEVEL = 2;
outPort.csvPath = '/mnt/scratch5/takeshi_dev_run3/csvSPOOL/';
outPort.imagePath = '/mnt/scratch5/takeshi_dev_run3/imageSPOOL/';
...
for i = 1:totN
    ...
    sJ = normalize(sJ);
    model(:,:,i) = sJ;
    fprintf(['done@' num2str(i) ':' num2str(totN) '\n']);
end
function [] = stomata_cnnVersion2(imageFile,convnet,freqK,R,oPath,rPath)
tic
HARDSIZE = 21;
...
if ~isempty(oPath)
    ...
    sliding = true;
    if sliding
        B = colfilt(I,[21 21],'sliding',@(block)lowMemCNN(block,convnet,[21 21],2));
    else

        I = im2col(I,[21 21],'sliding');
        I = reshape(I,[21 21 1 size(I,2)]);
        [classLabel PROB] = classify(convnet,single(I));

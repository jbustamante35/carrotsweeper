function [] = clearPipes(user)
    %%
    tic
    CMD = 'iquest --no-page "SELECT DATA_NAME,COLL_NAME,META_DATA_ATTR_VALUE,META_DATA_ATTR_NAME,META_DATA_ATTR_UNITS,META_DATA_MODIFY_TIME WHERE COLL_NAME LIKE ''/iplant/home/gxe/maizeData/cobData%''"';
    [o,r] = system(CMD);

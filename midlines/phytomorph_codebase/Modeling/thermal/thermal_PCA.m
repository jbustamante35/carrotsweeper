...
D = readtext('/home/nate/Downloads/widef.csv');
%%
D = readtext('/home/nate/Downloadclos/widef_licor_bad_data_purged.csv');
...
[preVARE_X,preVARE_Y,preVARE_LX,preVARE_LY,preX_model,norX_model,preY_model,X2Y] = pre_post_model(X,[240 241],3,[3 3]);
...
cell2csv('/mnt/snapper/nate/phenoType4.csv',newD4);

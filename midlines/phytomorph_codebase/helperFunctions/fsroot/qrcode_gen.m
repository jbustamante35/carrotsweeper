...
if(successloading)
    ...
    try
        ...
        qr_hints.put(com.google.zxing.EncodeHintType.CHARACTER_SET, 'utf-8');
        ...
        %qr = logical(zeros(M_java.getHeight(), M_java.getWidth(),'uint8'));
        %{
        toc
        
        import com.google.zxing.common.BitArray;
        ba = BitArray(M_java.getWidth());
        
        qr = zeros(M_java.getHeight(),M_java.getWidth());
        tic
        for i=1:M_java.getHeight()
            ba = M_java.getRow(i-1,ba);

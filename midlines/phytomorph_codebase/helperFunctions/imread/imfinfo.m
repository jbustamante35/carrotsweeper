...
%   $Revision: 1.1.6.19 $  $Date: 2011/11/09 16:53:21 $
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% get class type
try classType =  char(source.getClass().getSimpleName());catch ME;classType='NA';end;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% check for BSONfile
if strcmp(classType,'Bfile')
    import phytoGraph_lite.Bpersist.Bfs.*;
    source = char(source.getFullFileName());
    fprintf(['BSONfile@phytoGraph@my*imfinfo@ ' source '\n']);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

if (~isNonEmptyString(source) & ~strcmp(classType,'Bfile'))
    error(message('MATLAB:imagesci:imfinfo:badFilename'))
end

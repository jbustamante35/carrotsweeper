...
%  $Revision: 1.1.6.8 $  $Date: 2011/05/17 02:28:07 $
   ...
   if fid < 0
      error(message('MATLAB:imagesci:readpnm:fileOpen', filename, msg));
   end
   ...
   switch encoding
      ...
      otherwise
         error(message('MATLAB:imagesci:readpnm:badEncoding', filename));
   end

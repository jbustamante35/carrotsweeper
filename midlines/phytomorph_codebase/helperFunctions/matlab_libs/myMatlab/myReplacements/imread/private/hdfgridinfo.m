...
%   $Revision: 1.1.6.11 $  $Date: 2011/05/17 02:27:23 $
...
try
    ...
    try
        ...
        warning(message('MATLAB:imagesci:hdfgridinfo:couldNotRetrieveProjection', gridname, name, ext))
        projcode = [];
        zonecode = [];
        spherecode = [];
        projparm = [];
    ...
    warning(message('MATLAB:imagesci:hdfgridinfo:libraryError', me.message));
    gridinfo = [];
end
return;

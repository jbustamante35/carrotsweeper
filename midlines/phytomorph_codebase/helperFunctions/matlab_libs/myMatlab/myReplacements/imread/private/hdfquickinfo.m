...
%   $Revision: 1.1.6.11 $  $Date: 2011/05/17 02:27:29 $
...
while true
	...
	if status ~= 0
		hdfv('end',fileID);
		hdfh('close',fileID);
		error (message('MATLAB:imagesci:hdfquickinfo:getname', childID)); 
	end
...
if (fileID < 0)
    error(message('MATLAB:imagesci:hdfquickinfo:invalidFile', filename));     
end
...
for i=0:count-1
	...
	if status ~= 0
		...
		hdfan('end',anID);
		hdfh('close',fileID);
		error (message('MATLAB:imagesci:hdfquickinfo:gettagref', i)); 
	end
...
if (fileID < 0)
    error(message('MATLAB:imagesci:hdfquickinfo:invalidGridFile', filename));     
end
...
if (fileID < 0)
    error(message('MATLAB:imagesci:hdfquickinfo:invalidSwathFile', filename));     
end
...
if (fileID < 0)
    error(message('MATLAB:imagesci:hdfquickinfo:invalidPointFile', filename));     
end
...
fileID = hdfh('open',filename,'read',0);
if (fileID<0 || sdID<0)
    error(message('MATLAB:imagesci:hdfquickinfo:invalidSdFile', filename));     
end
anID = hdfan('start',fileID);
...
fileID = hdfh('open',filename,'read',0);
if (fileID < 0)
    error(message('MATLAB:imagesci:hdfquickinfo:invalidVdataFile', filename));     
end
anID = hdfan('start',fileID);
hdfv('start',fileID);
...
fileID = hdfh('open',filename,'read',0);
if (fileID < 0)
    error(message('MATLAB:imagesci:hdfquickinfo:invalid8bitRasterFile', filename));     
end
anID = hdfan('start',fileID);
...
fileID = hdfh('open',filename,'read',0);
if (fileID < 0)
    error(message('MATLAB:imagesci:hdfquickinfo:invalid24bitRasterFile', filename));     
end
anID = hdfan('start',fileID);

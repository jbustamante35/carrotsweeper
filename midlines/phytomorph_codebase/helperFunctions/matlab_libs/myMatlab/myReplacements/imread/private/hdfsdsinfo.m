...
%   $Revision: 1.1.6.9 $  $Date: 2011/05/17 02:27:35 $
...
elseif ischar(dataset)
    try
        ...
        warning(message('MATLAB:imagesci:hdfsdsinfo:nametoindex', dataset));
        return;
    end
end
...
try
    ...
    warning(message('MATLAB:imagesci:hdfsdsinfo:select'));
    return;
end

...
%   $Revision: 1.1.6.10 $  $Date: 2011/05/17 02:27:40 $
...
if vgID == -1
    warning(message('MATLAB:imagesci:hdfvgroupinfo:vgroupAttach'));
    return;
end
...
for i=1:length(childTags)
    switch childTags(i)
        ...
        case hdfml('tagnum','DFTAG_RI')
            raster24 = [raster24 hdfraster24info(filename,anID,childRefs(i),anID)]; %#ok<AGROW>
        ...
        otherwise
            warning(message('MATLAB:imagesci:hdfvgroupinfo:unknownVgroup', childTags( i )));
    end
end

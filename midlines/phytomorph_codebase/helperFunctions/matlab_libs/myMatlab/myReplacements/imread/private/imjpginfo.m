...
%   $Revision: 1.1.6.14 $  $Date: 2011/05/17 02:27:49 $
...
if (fid == -1)
    error(message('MATLAB:imagesci:imjpginfo:fileOpen', filename, msg));
end
...
if (~isequal(sig, [255; 216]))
    error(message('MATLAB:imagesci:imjpginfo:notJPGFile', filename));
end

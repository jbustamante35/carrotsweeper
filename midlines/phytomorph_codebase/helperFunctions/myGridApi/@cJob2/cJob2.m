classdef cJob2 < handle
    ...
    properties (Access = private) % for shell file
       ...
       % downloaded
       mainline211 = 'curl -H "Pragma:" --retry 3 --retry-delay 6 -o SLIBS.tar.gz http://proxy.chtc.wisc.edu/SQUID/SLIBS.tar.gz';
       ...
       mainline221 = 'curl -H "Pragma:" --retry 3 --retry-delay 6 -o core-3.2.1.jar http://proxy.chtc.wisc.edu/SQUID/ndmiller/core-3.2.1.jar';
       mainline222 = 'curl -H "Pragma:" --retry 3 --retry-delay 6 -o javase-3.2.1.jar http://proxy.chtc.wisc.edu/SQUID//ndmiller/javase-3.2.1.jar';
       ...
       mainline311 = 'curl -H "Pragma:" --retry 3 --retry-delay 6 -o dcraw http://proxy.chtc.wisc.edu/SQUID/ndmiller/dcraw';
       ...
       mainlineDCR1 = 'curl -H "Pragma:" --retry 3 --retry-delay 6 -o lcms_lib.tar.gz http://proxy.chtc.wisc.edu/SQUID/ndmiller/lcms_lib.tar.gz';
